...
<main class="main">
	...
	<div class="container-fluid">
	  <div class="animated fadeIn">
		...
		<div class="row">
		  <div class="col-md-12">
			<div class="card">
			  <div class="card-header"><?php echo T_('News') ;?>
				  <div class="card-header-actions">
					<a class="btn btn-sm btn-warning text-white" href="add-news.aspx"> <?php echo T_('Add new');?></a>
				  </div> 
			  </div>
			  <div class="card-body">	
				<?php
					if(isset($_GET["id_del"]) && isset($_GET["delete"]) && (int)$_GET["id_del"]!=0 )
					{
						$id_del = (int)$_GET["id_del"];
							 ...
							 $affect = $dbf->deleteDynamic("informations", "id='" . $id_del . "'");
							 if ($affect > 0)
							 {
				...
				<table class="table table-striped table-bordered datatable table-vcenter">
					...
					<tbody>
						<?php
									...
									$result = $dbf->getDynamic("informations", "", "id DESC");
										  ...
										  while ($row = $dbf->nextData($result)) {
											   ...
											   echo '<tr class="cell2">
													...
													<td class="itemText">';
                                                                ...
                                                                echo '<a href="' .HOST. 'edit-post.aspx?id=' . $row['id'] . '" class="btn btn-effect-ripple btn-xs btn-secondary" data-toggle="tooltip" title="" style="overflow: hidden; position: relative;" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
																<a data-id="'.$row['id'].'" class="delete_post_from_list text-white btn btn-effect-ripple btn-xs btn-danger" data-toggle="tooltip" title="" style="overflow: hidden; position: relative;" data-original-title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
  ...
  <script type="text/javascript" src="js/custom/delete_post.js"></script>
  <script type="text/javascript">
//<![CDATA[
