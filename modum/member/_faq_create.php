			...
			<?php
				if (isset($_POST["created_post"])) {
				  ...
				  //$postcontent = stripslashes($_POST['postcontent']);
						 ...
						 $affect = $dbf->insertTable_2("frequently_asked_questions", $array_col);
						 if ($affect > 0)
						 {
				  ...
				  <div class="collapse show" id="collapseCategory">
					  <div class="card-body">
						<fieldset class="form-group">
						  ...
						  <button class="btn btn-effect-ripple btn-primary" name="created_category" onClick="window.location.href='/created-category-faq.aspx'" type="button" style="overflow: hidden; position: relative; float:right; margin-bottom: 10px;"><?php echo T_('Add category');?></button>
					  </div>
				  </div>
				</div> <!-- card -->
			  </div> <!-- col-md-3 -->
