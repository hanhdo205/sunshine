			...
			<tr>
				...
				<td style="border:white">
					<div style="color:#818181;font-size:10.5pt;font-family:Verdana"><span class="im">
						<a href="mailto:{{ email }}" target="_blank">{{ dear_text }}</a><br>
						
						<br>
						{{ message_body_text }}</span>	

						<br>
						<br>
					   
						<p style="text-align:center">
						<a href="{{ link }}" style="background-color:#41A3E4;color:#ffffff;padding:15px 30px;border-radius:3px;text-decoration:none" target="_blank">
						  {{ reset_password_text }}
						</a></p>
