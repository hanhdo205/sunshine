<table border="1" cellpadding="0" cellspacing="0" style="border:solid #e7e8ef 3.0pt;font-size:10pt;font-family:Calibri" width="600">
			...
			<tr>
				...
				<td style="border:white">
					<br>
					<h1><span style="font-size:19.0pt;font-family:Verdana;color:black">{{ admin_subject }}</span></h1>
					<br>
				</td>
			</tr>
			<tr>
				...
				<td style="border:white">
					<div style="color:#818181;font-size:10.5pt;font-family:Verdana"><span class="im">
					   ...
					   <p style="text-align:left">
						  <strong>ユーザーID: {{ userid }}</trong>
					   </p>	
					   <p style="text-align:left">
						  <strong>会社名: {{ company_name }}</trong>
					   </p>						   
					   <p style="text-align:left">
						  <strong>ユーザー名: {{ username }}</trong>
					   </p>
					   <p style="text-align:left">
						  <strong>メールアドレス: {{ email }}</trong>
					   </p>
			...
			<tr>
				<td colspan="2" style="height:30pt;background-color:#e7e8ef;border:none">
					<center><a href="{{ url }}" style="color:#5b9bd5" target="_blank">{{ url }}</a><br></center>
				</td>
			</tr>
		</tbody></table>