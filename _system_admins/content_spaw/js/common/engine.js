...
SpawEngine.openDialog = function(module, dialog, editor, arguments, querystring, callback, tbi, sender)
{
  ...
  var durl = SpawEngine.spaw_dir + 'dialogs/dialog.' + SpawEngine.platform + '?flag=<?php echo md5(SpawConfig::getStaticConfigValue('SPAW_PASS'))?>&module=' + module + '&dialog=' + dialog 
