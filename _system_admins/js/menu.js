/***********************************************************************************************
	...
	***********************************************************************************************/
	...
	var topMenuSpacer = -6; // Horizontal space(pixels) between the main menu items
	...
	*/
    ...
    function showHide_rememberActiveTab()
	{   if(ct!='') clearTimeout(ct);
		...
		if(rememberActiveTabByCookie){
			...
			Set_Cookie('dhtmlgoodies_tab_menu_tabIndex_1',(theId-1),theExprire);
		}
	}
    function MenuSelect()
	{
	   ct= setTimeout(initMenu,5000);
	}
	function initMenu()
	{
