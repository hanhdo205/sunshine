...
function item_click(){
	...
	if(_this.items[this._index].url){
		...
		if (str_url.indexOf("http")==-1){
            ...
            var wscreen=screen.availWidth-50;
            var hscreen=screen.availHeight-200;
            openBox(_this.items[this._index].url,wscreen,hscreen);
		}
	}
}
...
return'<div id="'+id+'" class="'+sClassName+'">'+'<div class="content"><table class="items" cellpadding="0" cellspacing="0" border="0">'+'<tr><td colspan="2" height="'+TransMenu.menuPadding+'"></td></tr>'+aHtml.join('')+'<tr><td colspan="2" height="'+TransMenu.menuPadding+'"></td></tr></table>'+'<div class="shadowBottom"><img src="'+TransMenu.spacerGif+'" width="1" height="1"></div>'+'<div class="shadowRight"><img src="'+TransMenu.spacerGif+'" width="1" height="1"></div>'+'<div class="background"><img src="'+TransMenu.spacerGif+'" width="1" height="1"></div>'+'</div></div>';}}
